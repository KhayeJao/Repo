...
<div class="row">
    ...
    <div class="form-group field-coupons-code required">
        <label class="control-label col-sm-3" for="minimum_order">Minimum Order</label>
        <div class="col-sm-6">
            <?php
            echo Html::input('number', 'discount_perameters[minimum_order]', ($coupon_details ? $coupon_perameter['minimum_order'] : 500), ['class' => 'form-control', 'required' => 'required','id'=>'minimum_order']);
            ?>
            <div class="help-block help-block-error ">Minimum Order in Rs</div>
        </div>
    </div>
