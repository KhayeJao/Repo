...
<div class="menu-view">
    ...
    <?php $this->beginBlock('common\models\MenuMaster'); ?>
    ...
    <div style='position: relative'><div style='float: right;'>
            <?=
            Html::a(
                    '<span class="glyphicon glyphicon-list"></span> ' . 'List All' . ' Dishes', ['dish-master/index', 'DishesMasterSearch' => ['menu_id' => $model->id]], ['class' => 'btn text-muted btn-xs']
            )
            ?>
        </div>
    ...
    Tabs::widget(
            [
                ...
                'items' => [ [
                        ...
                        'content' => $this->blocks['common\models\MenuMaster'],
                        'active' => true,
                    ], [
