<?php use yii\helpers\Url;
 ...
 ?>
  ...
  $(document).on('click', '.add_to_cart_dish', function () {
        ...
        imgtodrag.attr('src', '<?= Yii::$app->params['base_url'] . 'backend/web/images/step-4-process.png'; ?>');
        if (imgtodrag) {
...
/*
    ...
    */
    ...
    window.location = "<?= Url::to(['tableorder/checkout']); ?>"+"?restaurant_id="+restaurant_id+"&table_no="+<?= $_SESSION['cart']['table_no']?>;
    });
