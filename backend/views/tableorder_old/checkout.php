...
$this->params['breadcrumbs'][] = ['label' => 'Menu list', 'url' => ['tableorder/placeorder?table_no='.$_GET['table_no'].'']];
        ...
        <div class="col-md-8">
            ...
            <div class="">
                ...
                <p> 
                    ...
                    <?= $form->field($model, 'email')->textInput(['maxlength' => 400, 'email','value' => ($user_model ? $user_model->email : ' ')]) ?>
