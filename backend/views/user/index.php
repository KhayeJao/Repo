        ...
        <p class="pull-left">
            ...
            if (\Yii::$app->user->can('placeOrder')) {
                Modal::begin([
                    ...
                    'toggleButton' => ['label' => 'Place order as a guest', 'class' => 'btn btn-success'],
                ]);
            ...
            'columns' => [
                ...
                [
                    ...
                    'urlCreator' => function($action, $model, $key, $index) {
                        ...
                        $params = is_array($key) ? $key."&k" : [$model->primaryKey()[0] => (string) $key."&k"];
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'urlCreator' => function($action, $model, $key, $index) {
                        // using the column name as key, not mapping to 'id' like the standard generator
                        $params = is_array($key) ? $key."&l" : [$model->primaryKey()[0] => (string) $key."&l"];
                        $params[0] = \Yii::$app->controller->id ? \Yii::$app->controller->id . '/' . $action : $action;
                        return Url::toRoute($params);
                    },
                            'buttons' => [
...
//                        'fb_id',
 ...
 <?=
    ...
    'items' => [
        [
            'label' => 'Khayejao Users',
            'content' => $this->blocks['main'],
        ],
        [
            'label' => 'Logistic Users',
