            ...
            <tbody>
				...
				?>
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="padding:20px 15px 0px 0px;"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $dishValue->dish_price; ?></td>

                        <td class="text-right" style="padding:20px 15px 0px 0px;"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $dishValue->dish_price * $dishValue->dish_qty ?></td>
