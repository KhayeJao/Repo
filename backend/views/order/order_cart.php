...
<div class="dataTables_wrapper form-inline no-footer">
                ...
                if (!empty($_SESSION['cart']['dishes'])) {
                    foreach ($_SESSION['cart']['dishes'] as $dishesKey => $dishesValue) {
                        ...
                        <tr role="row" class="<?= ($boolVar ? 'odd' : 'even') ?>">
                             <td class="v-align-middle semi-bold sorting_1 " style="width:20%">
                                <div class="row">
									<div class="col-md-6 col-xs-6 col-sm-6 gutter numericqty clearfix">
    ...
    <div id="chharges">
        ...
        <div class="col-md-12">
                ...
                <p class="" id="total_p"><button type="button" id="apply_coupon_code_button" class="btn btn-promo">Apply</button></p>
            </div>
        <div class="button-sav">
            ...
            <button type="button" id="checkout_button" <?= ($discounted_subtotal < $restaurant_model->min_amount ? 'disabled' : '') ?> class="btn btn-sm btn-danger1">Checkout <?= ($subtotal < $restaurant_model->min_amount ? '(Min. order value ' . $restaurant_model->min_amount . ' Rs.)' : '') ?></button>
            </li>
            </ul>
        </div>
    </div>
