...
$this->params['breadcrumbs'][] = ['label' => 'Orders', 'url' => BASE_URL. 'backend/web/index.php/restaurant/view?id='.$_GET['Order']['restaurant_id']];
    ...
    <div class="table-responsive">
        ...
        $gridColumns = [
            [
                ...
                'filter' => ['Placed' => 'Placed', 'Approved' => 'Approved','OnDelivery'=>'OnDelivery', 'Rejected' => 'Rejected', 'Completed' => 'Completed'],
                            ...
                            [
                                    ...
                                    return [
                                        ...
                                        'afterInput' => function($form, $widget) {
                                            ...
                                            echo "<div class='editable_status_ta_div form-group' style='display:none'>" . Html::textarea('status_other_reason', '', ['class' => 'other_reason_ta form_control', 'placeholder' => 'Other reason']) . "</div>";
                                                ...
                                                'header' => 'Status',
                                                'inputType' => Editable::INPUT_DROPDOWN_LIST,
                                                'data' => ['Placed' => 'Placed', 'Approved' => 'Approved', 'Rejected' => 'Rejected', 'OnDelivery'=>'OnDelivery','Completed' => 'Completed'],
                                                'formOptions' => ['action' => Url::to('changestatus')],
                                                'pluginEvents' => [
                                ...
                                <?php } else { ?>
                                    ...
                                    GridView::widget([
                                                    ...
                                                    return [
                                                        ...
                                                        'afterInput' => function($form, $widget) {
                                                            ...
                                                            echo "<div class='editable_status_ta_div form-group' style='display:none'>" . Html::textarea('status_other_reason', '', ['class' => 'other_reason_ta form_control', 'placeholder' => 'Other reason']) . "</div>";
                                                                ...
                                                                'header' => 'Status',
                                                                'inputType' => Editable::INPUT_DROPDOWN_LIST,
                                                                'data' => ['Placed' => 'Placed', 'Approved' => 'Approved','OnDelivery'=>'OnDelivery', 'Rejected' => 'Rejected', 'Completed' => 'Completed'],
                                                                'formOptions' => ['action' => Url::to('changestatus')],
                                                                'pluginEvents' => [
                                                                    "editableSuccess" => "function(event, val, form, data) { location.reload(); }",
                                                                ],
										...
										<?php $this->registerJs('setTimeout(function(){ window.location.reload(1); }, 300000);', \yii\web\VIEW::POS_END); ?>
