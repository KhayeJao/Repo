...
<div class="order-view">
    ...
    <h3>
        <?= "Order ID : " . $model->order_unique_id ?> </h3>   <?= Html::a('<span class="glyphicon glyphicon-download"></span> ' . 'Download PDF', ['outputinfo', 'id' => $model->id, 'act' => 'download'], ['class' => 'btn btn-info pull-right', 'target' => '_blank']) ?> <?= Html::a('<span class="glyphicon glyphicon-print"></span> ' . 'Print', ['outputinfo', 'id' => $model->id, 'act' => 'print'], ['class' => 'btn btn-info pull-right m-r-10', 'target' => '_blank']) ?>
