        ...
        <div class="col-md-8">
            ...
            <div class="">
                ...
                <?php if (!$user_model) { ?>
                    ...
                    $restaurant_areas = $areas_query->where(['IN', 'id', ArrayHelper::getColumn(common\models\RestaurantArea::findAll(['restaurant_id' => $restaurant_model->id]), 'area_id')])->all();
...
Modal::end();
?>
<?php $this->registerJs('var user_id = ' . ($user_model ? $user_model->id : 0) . '; var restaurant_id = ' . $restaurant_model->id . '; var is_restaurant_open = ' . ($restaurant_model->isOpen() ? 1 : 0) . ';', \yii\web\VIEW::POS_END); ?>
<?php if ($user_model) {
...
<?php $this->registerCss("#checkout_button{display:none} .table.table-condensed thead tr th, .table.table-condensed tbody tr td, .table.table-condensed tbody tr td *{white-space:normal} .sub-tr td{border-bottom : none !important; padding:0 20px !important;}"); ?>
<?php
if ($user_model) {
