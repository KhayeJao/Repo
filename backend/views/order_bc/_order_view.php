                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <p>
                            ...
                            <?php if($isView){?>
                            SMS Number : <?= $model->restaurant->sms_number?><br>
                            Order Number : <?= $model->restaurant->order_number?><br>
...
<div class="respons-table">
            ...
            <tbody>
                ...
                <?php foreach ($model->orderDishes as $dishKey => $dishValue) { ?>
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="padding:20px 15px 0px 0px;"><span class="rupyaINR">Rs <?= $dishValue->dish_price ?></span></td>

                        <td class="text-right" style="padding:20px 15px 0px 0px;"><span class="rupyaINR">Rs <?= $dishValue->dish_price * $dishValue->dish_qty ?></span></td>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <?php if ($orderToppingValue->price) { ?>
                                    ...
                                    <span class="rupyaINR">Rs <?= $orderToppingValue->price ?></span>
        ...
        <div class="row">
            ...
            <div class="col-md-4 pull-right table-responsive" >
