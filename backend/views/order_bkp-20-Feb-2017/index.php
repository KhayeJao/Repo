                    ...
                    'buttons' => [
                                ...
                                <?php } else { ?>
                                    ...
                                    GridView::widget([
                                            ...
                                            [
                                                ...
                                                'urlCreator' => function($action, $model, $key, $index) {
                                                    ...
                                                    [
                                                        ...
                                                        'vAlign' => 'middle',
                                                        'filterType' => GridView::FILTER_SELECT2,
                                                        'filter' => ['Placed' => 'Placed', 'Approved' => 'Approved', 'Rejected' => 'Rejected', 'Rejected' => 'Rejected','Completed' => 'Completed'],
                                                        'filterInputOptions' => ['placeholder' => 'Select Status'],
                                                        'filterWidgetOptions' => [
                                                            'pluginOptions' => ['allowClear' => true],
                                                        ],
						                ...
						                <?php $this->registerJs('setTimeout(function(){ window.location.reload(1); }, 20000);', \yii\web\VIEW::POS_END); ?>
