                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <table width="270" align="right" cellpadding="0" cellspacing="0" border="0" class="table518c" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                                                                                                <tbody><tr>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <!--NAME-->	
                                                                                                                        <td class="invInfoA"><?= $table_booking->user->first_name . " " . $table_booking->user->last_name ?></td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <!--email-->	
                                                                                                                        <td class="invInfoA"><strong>Mobile : </strong> <?= $table_booking->user->mobile_no ?>  <br> <strong>Email : </strong><?= $table_booking->user->email ?></td>
                                                                                                                    </tr>
                                                                                                                </tbody></table>
                                                                                                            ...
                                                                                                            <table width="270" align="left" cellpadding="0" cellspacing="0" border="0" class="table518c2" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                                                                                                <tbody><tr>
                                                                                                                        ...
                                                                                                                        <td width="250" class="invInfoB"><strong><?= $table_booking->tableBookingTables[0]->table->restaurant->title ?></strong> <br><?= $table_booking->tableBookingTables[0]->table->restaurant->address . ", " . $table_booking->tableBookingTables[0]->table->restaurant->area . ", " . $table_booking->tableBookingTables[0]->table->restaurant->city ?></td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <table width="270" align="right" cellpadding="0" cellspacing="0" bgcolor="#ffffff" border="0" class="table518c" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                                                                                                <tbody><tr>
                                                                                                                        <!--INVOICE DATE-->	
                                                                                                                        <td width="270" class="invInfoA"><a href="#"><strong>Check-In datetime</strong>: <?= Yii::$app->formatter->asDatetime($table_booking->checkin_datetime) ?></a></td>
                                                                                                                    </tr>
                                                                                                                </tbody></table>
                                                                                                            <table width="270" align="left" cellpadding="0" cellspacing="0" bgcolor="#ffffff" border="0" class="table518c" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                                                                                                <tbody><tr>
                                                                                                                        <!--INVOICE NO-->	
                                                                                                                        <td width="250" class="invInfoB"><a href="#"><strong>Order ID:</strong> <?= $table_booking->order_unique_id ?></a></td>
                                                                                                            ...
                                                                                                            <table align="center" cellpadding="0" cellspacing="0" border="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                                                                                                <tbody>
                                                                                                                    <tr style="background-color:#f9f9f9;">
                                                                                                                        <td width="189" valign="middle" height="25" class="invReg">Table #</td>
                                                                                                                        <td width="189" valign="middle" height="25" class="invReg">Seats</td>
                                                                                                                    ...
                                                                                                                    <?php foreach ($table_booking->tableBookingTables as $booked_tables_key => $booked_tables_value) { ?>
                                                                                                                        <tr style="background-color:#f4f4f4;">
                                                                                                                            <td width="189" valign="middle" height="25" class="invReg"><?= $booked_tables_value->table->table_id ?></td>
                                                                                                                            <td width="189" valign="middle" height="25" class="invReg"><?= $booked_tables_value->table->no_of_seats ?></td>
                                                                                                                            <td width="189" valign="middle" height="25" class="invReg">Rs. <?= $booked_tables_value->table_price ?></td>
                                                                                                                        </tr>
                                                                                                                    <?php }
                                                                                                                    ?>
                                                                                                            ...
                                                                                                            <table align="center" cellpadding="0" cellspacing="0" border="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                                                                                                ...
                                                                                                                <tbody>
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="189" valign="middle" height="25" class="invReg">Rs. <?= $table_booking->sub_total ?></td>
                                                                                                                    </tr>
                                                                                                                    <?php if ($table_booking->discount_amount > 0) { ?>
                                                                                                                        <tr>
                                                                                                                            <td width="189" class="invReg"></td>
                                                                                                                            <td width="189" valign="middle" height="25" class="invReg">Discount</td>
                                                                                                                            <td width="189" valign="middle" height="25" class="invReg">Rs. <?= $table_booking->discount_amount ?></td>
                                                                                                                        </tr>
                                                                                                                    <?php } ?>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="189" valign="middle" height="25" class="invReg">Rs. <?= $table_booking->grand_total ?></td>
                                                                                                                    </tr>
                                                                                                                    <!-- end group -->
                                                                                                                </tbody></table>
                                                                                                            ...
                                                                                                            <table width="567" align="left" cellpadding="0" cellspacing="0" border="0" class="table518b" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                                                                                                <tbody><tr>	
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td height="20" class="RegularTextTD"><strong>Order Date-Time :</strong><?= Yii::$app->formatter->asDatetime($table_booking->booking_date) ?></td>
                                                                                                                    </tr>
                                                                                                                </tbody></table>
                                                                                                        </td>
                                                                                                        <td width="20" class="wz"></td>
                                                                                                                            ...
                                                                                                                            <table width="528" align="center" cellpadding="0" cellspacing="0" border="0" class="table528Button" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                                                                                                                <tbody><tr>	
                                                                                                                                    ...
                                                                                                                                    <tr>	
                                                                                                                                        ...
                                                                                                                                        <td width="528" align="center" class="td528Button">Thank You For Your Booking!</td>
                                                                                                                                    </tr>
                                                                                                                                    <tr>	
                                                                                                                                        <td height="8" style="font-size:0;line-height:0;">&nbsp;</td>
                                                                                                                                    </tr>
                                            ...
                                            <table width="610" align="left" cellpadding="0" cellspacing="0" border="0" bgcolor="#ededed" class="table600">         	
                                                <tbody><tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="5" class="mailingOptionsTD"><a href="#" target="_blank">Contact Us</a> | <a href="#" target="_blank">Terms & Condition </a> | <a href="#" target="_blank">Privacy Policy </a><br>©2015 Khaye Jao. All rights reserved</td>
                                                        <!--= End of the section -->	
                                                    </tr>
                                                    <tr>
