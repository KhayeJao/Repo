...
use yii\helpers\Url;
   ...
   $restaurant = Restaurant::findOne(['id' => $model->restaurant_id]);
...
<html lang="en">
    <head>
        ...
        <title>Resturant  - <?= $restaurant->title?></title> 
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="promocell" bgcolor="#ededed" width="600" >
                                                        <h4 class="secondary" style="color:#333333 !important;font-size:28px;line-height:32px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:15px;padding-top:0;padding-bottom:0;font-weight:bold;"><strong>Review  - <?= $restaurant->title?></strong></h4>
                                                         ...
                                                         <p style="color:#454545;font-size:15px;line-height:22px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:5px;padding-top:0;padding-bottom:0px;font-weight:normal;">
                                                          User Name : <?php echo $user->first_name." ".$user->last_name; ?>
                                                        </p>
                                                        ...
                                                        Review Title : <?= $model->title ?>
                                                         ...
                                                         <p style="color:#454545;font-size:15px;line-height:22px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:5px;padding-top:0;padding-bottom:0px;font-weight:normal;">
                                                        Review Rating : <?= $model->rate ?>
                                                        </p>
                                                        
                                                        
                                                        
                                                        <p style="color:#454545;font-size:15px;line-height:24px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:5px;padding-top:0;padding-bottom:0px;font-weight:bold;">
