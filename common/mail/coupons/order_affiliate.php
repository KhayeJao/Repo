                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="promocell" bgcolor="#ededed" width="600" >
                                                        <h4 class="secondary" style="color:#333333 !important;font-size:28px;line-height:32px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:15px;padding-top:0;padding-bottom:0;font-weight:bold;"><strong>Congratulations, You have done it!</strong></h4>
                                                        ...
                                                        <p style="color:#454545;font-size:15px;line-height:22px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:5px;padding-top:0;padding-bottom:0px;font-weight:normal;">
                                                            Your 3 of friends have successfully ordered food from <?= Yii::$app->name ?> with affiliation of your order with ID <?= $model->order_unique_id ?>.<br/>
                                                            You can place order of Rs.<?= $model->grand_total ?> for free!<br/>
                                                        </p>
