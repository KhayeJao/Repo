                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="promocell" bgcolor="#ededed" width="600" >
                                                        <h4 class="secondary" style="color:#333333 !important;font-size:28px;line-height:32px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:15px;padding-top:0;padding-bottom:0;font-weight:bold;"><strong>Dear, <?= $userModel->first_name ?>!</strong></h4>
                                                        <p style="color:#454545;font-size:15px;line-height:22px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:5px;padding-top:0;padding-bottom:0px;font-weight:normal;">
                                                            Here is a coupon code for your reward points that you claimed!
                                                            Coupon code is valid upto <?= Yii::$app->formatter->asDate($coupon_model->expired_on)  ?><br/>
                                                        </p>
                                                        <p style="color:#454545;font-size:22px;line-height:24px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:5px;padding-top:0;padding-bottom:0px;font-weight:bold;">
                                                            Coupon Code : <?= $coupon_model->code ?>
                                                        </p>
                                                        <p style="color:#454545;font-size:22px;line-height:24px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:5px;padding-top:0;padding-bottom:0px;font-weight:bold;">
                                                            Coupon Amount : Rs. <?= $couponAmount ?>
                                                        </p>
