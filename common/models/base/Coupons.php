...
class Coupons extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['code', 'coupon_key', 'title', 'description', 'type', 'coupon_perameter', 'notify', 'status', 'created_on','expired_on'], 'required'],
            [['type', 'notify', 'status','deal_mobile_app_only'], 'string'],
            [['created_on'], 'safe'],
            [['code'], 'string', 'max' => 30],
    ...
    public function attributeLabels() {
        return [
            ...
            'notify' => 'Notify',
            'deal_mobile_app_only' => 'Deal only for mobile App',
            'status' => 'Status',
