 ...
 */
Yii::$app->params['CImagePath'] = Yii::getAlias('@uploadPath') . '/uploads/trending/';
Yii::$app->params['CImageUrl'] = Yii::getAlias('@uploadUrl') . '/uploads/trending/';
...
class Trending extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['title', 'description', 'image', 'status','type'], 'required'],
            [['status','type','link'], 'string'],
